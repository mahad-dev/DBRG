...
export default function Address() {
  return (
    <section className="w-full mx-auto bg-[#0f0f0f] text-white py-16 px-16 flex flex-col ">
      
{/* Title */}
<h2
  className="text-[62px] font-normal leading-[100%] text-[#C6A95F] mb-3"
...
{/* Subtitle */}
<p
  className="max-w-8xl mx-auto text-gray-300 font-gilory-medium mb-10 text-[24px] leading-[100%]"
