      ...
      <div className="grid grid-cols-1 lg:grid-cols-[6fr_4fr] gap-6">
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <StatsCard title="New Applications" value="2,000" />
            <StatsCard title="Approved Applications" value="1,284" />
          </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 mt-2">
            <Button
              variant="outline"
              className="w-full border border-[#caa95a] text-[#caa95a] rounded-md py-5 hover:bg-[#caa95a]/20 transition"
            >
              Add News
            </Button>
