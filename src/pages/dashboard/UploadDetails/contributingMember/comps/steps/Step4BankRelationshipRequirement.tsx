...
export default function Step4BankRelationshipRequirement() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Use document ID from immediate upload (no upload on save)
      const bankFileId = bankReferenceLetterFileId || extractIdFromPath(formData.bankRelationReq?.bankReferenceLetterFilePath || null);
  ...
  return (
    <Formik
      ...
      validationSchema={contributingMemberStep3Schema}
      onSubmit={handleSave}
      enableReinitialize
    ...
    <div className="w-full min-h-screen bg-[#353535] rounded-lg p-6 md:p-8 shadow-lg">
      ...
      {/* Upload Section */}
      <div className="mt-10">
        <Label className="text-white font-gilroy text-[18px] mb-2 block">
