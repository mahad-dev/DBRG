...
import { contributingMemberStep7Schema } from "@/validation";
...
export default function Step7DataProtection() {
  ...
  return (
    <Formik
      ...
      validationSchema={contributingMemberStep7Schema}
      onSubmit={handleSave}
      enableReinitialize
    >
      {({ submitForm }) => (
          ...
          <CardContent className="space-y-8 sm:space-y-6">
            ...
            <div className="mt-10 flex justify-start gap-4">
              <Button
                ...
                className="w-[132px] h-[42px] rounded-[10px] border border-white text-white"
              >
                Back
              </Button>
