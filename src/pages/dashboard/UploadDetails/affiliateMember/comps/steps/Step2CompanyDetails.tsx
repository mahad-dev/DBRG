...
export default function Step2CompanyDetails({ onNext }: StepProps): React.JSX.Element {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let tradeLicenseDocumentId: number | null = form.tradeLicenseDocument;
      let coiDocumentId: number | null = form.certificateOfIncorporation;
      let passportDocumentId: number | null = form.passportDocument;
      let nationalIdDocumentId: number | null = form.nationalIdDocument;
      let vatDocDocumentId: number | null = form.vatDocument;
      let taxRegDocDocumentId: number | null = form.taxRegistrationDocument;
      let addressProofDocumentId: number | null = form.addressProofDocument;
      let tradeAssociationCertificateDocumentId: number | null = form.accreditationCertificate;
  ...
  return (
    <div className="w-full bg-[#353535] rounded-lg p-6 md:p-8 shadow-lg min-h-screen text-white">
      ...
      <div className="mt-6">
        ...
        {form.taxRegistrationDocumentPath && (
          <a
