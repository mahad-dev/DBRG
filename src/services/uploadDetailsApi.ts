...
async saveUploadDetails(
  ...
  const fullPayload = {
    ...
    ...(sectionNumber === MemberApplicationSection.FinancialThreshold && { financialThresholds: payload.financialThresholds }),
    ...(sectionNumber === MemberApplicationSection.RegulatorCompliance && { regulatoryCompliance: payload.regulatoryCompliance }),
